            ...
            <b-col cols="12" md="12" lg="6" class="margin-top-account">
                <div class="sucess-code">
                    ...
                    <b-form class="text-center">
                       ...
                       <h2 class="login-title mb-1 mt-4">Welcome to Float Care</h2>
                       <p class="login-create-user">Congratulations you are all set to start enjoying all the benefits of Float Care.</p>
