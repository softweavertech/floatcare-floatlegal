        ...
        <b-row class="mt-5">
            ...
            <b-col cols="12" md="12" lg="6" class="margin-top-account">
                <div class="sucess-code">
                    <b-card class="p-3 login-container-border col-sm-8 " >
                    <b-form class="text-center">
                        <div class="border-custom">
                         <img src="@/assets/images/Icon/Icons/ic_check.svg"></div>
                        <h6 class="login-create-user">Thank you your access is currently being verified. </h6>
                        <h6 class="login-create-user">Once you verified, you will receive an emailinviting you to access FloatLegal.</h6>                     
                    </b-form>
                </b-card>
                </div>
            </b-col>
