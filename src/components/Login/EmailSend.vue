                ...
                <div class="sucess-code">
                    ...
                    <b-form class="text-center">
                        <div class="border-custom">
                         <img src="@/assets/images/Icon/Icons/email_sent.svg"></div>
                       <h2 class="login-title mb-1 mt-4">Email Sent </h2>
                       <p class="login-create-user">Please check your email, we have sent reset password link to your email successfully.</p>

                       <b-row> 
                         <b-col cols="12" md="12" lg="12" class="mt-4">
                          <button class="btn btn-primary w-100" @click="ContiunePayment">Back to login</button>
                         </b-col>
