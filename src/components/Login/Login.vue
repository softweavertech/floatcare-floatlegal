...
.card.p-3.login-container-border {
    padding: 2rem !important;
}
div#input-group-1, .col.col-12.pt-1 {
  margin: 25px auto;
}
  h2.login-title {
...
.col.col-12.pt-1.newUser {
    margin-top: 0px;
}
div#input-group-1 label {
    margin-bottom: 20px;
}
.col-lg-5 {
    width: 47.666667%;
  ...
  <b-container class=" mt-5 margin-container-top">
    <b-row class="mt-5">
      <b-col class="login-container text-center" cols="12" md="12" lg="6">
        <img src="/src/assets/images/logo.svg" class="login-650 login-logo-img mb-2" alt="Float Care 2.0" />
        <img src="/src/assets/images/Graphics.png" class="login-650 login-svg-custom" alt="Float Care 2.0" />
      </b-col>
          ...
          <b-card class="p-3 login-container-border col-sm-10 mx-auto">
            <b-form @submit="login" @reset="onReset" v-if="show">
              <h2 class="login-title mb-3">Login</h2>
               ...
               <b-col cols="12 pt-1 newUser">
                <span v-if="errorField" class="mt5 ">{{ errorMessage }}</span>
                <p class="login-create-user">New User? <a href="/create-account"
                    class="login-create-account ml-1">Create an account</a></p>
              </b-col>

              <b-form-group id="input-group-1" label="Email address" class="login-create-user" label-for="input-1">
                <b-form-input id="input-1" v-model="email" placeholder="Enter email" autocomplete="off"></b-form-input>
              ...
              <b-col cols="12 pt-1">
                <span v-if="errorField" class="mt5 ">{{ errorMessage }}</span>
                <p class="login-create-user text-end"><a href="/forgot-password"
                    class="login-create-account ml-1">Forgot Password?</a></p>
              </b-col>
              <b-button class="btn btn-primary col-12 login-btn" type="submit" variant="primary">Login
              </b-button>
            </b-form>
          </b-card>
        </div>
            ...
            if (response.data.success == true) {
              ...
              if (token) {
                ...
                //     console.log(data.data.data)
                    var cookieEncryptedResult = `IShzhZMhjTDzBC9Y35TiL7VsqzF6bE1wjtYRr49IhTq%2BYoBB%2Fzghl6J%2BizmRxVSjXMXRlQr19nuWCSjLzkIk0nxYznYl7yKykzrDZXrc7WwelMvxZDgZCBIcTo5vxZrZkG1dk8s47qdzoXKFrWUBfeG49o7TCcR5I8GneUYe0KE%3D`
